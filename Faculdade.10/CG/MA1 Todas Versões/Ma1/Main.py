...
image = pygame.image.load(r'C:\Users\andre\Desktop\CG\Ma1\img3.png') 
pygame.display.set_caption(windowTitle)
windowSurface.blit(image, (0, 380)) 
...
# Programa ******************************
	...
	#Primitivas.LinhaBresenhamBaixa(Ponto(400,30 ), Ponto(450,50), pixArray, 0xFFFFFF)
	...
	# ------- Quadrante 2 - Translacao sendo aplicada no Espelhamento - Cisalhamento -------
	...
	#Rotacao Aplicada No OBJ 2 (Triangulo)
	#obj2Coordenadas=[Ponto(1170,390),Ponto(1100,390),Ponto(1135,344)]
	#Primitivas.Poligono(obj2Coordenadas,pixArray,0xFFFFFF)
	lista3 = [MatrizRotacao(110)]
	Primitivas.Poligono(transformada(obj2Coordenadas,lista3),pixArray,0xFFFFFF)
	...
	#quadradoCoordenadas2=[Ponto(400,770),Ponto(300,770),Ponto(300,870),Ponto(400,870)]
	#meusPontos5 = [Ponto(433, 500), Ponto(380, 590), Ponto(487, 580)]
	meusPontos5 = [Ponto(253, 500), Ponto(200, 590), Ponto(307, 580)]
	Primitivas.Poligono4(meusPontos5, pixArray, 0xFFFF00)
	#Primitivas.Poligono(Mapeamento(meusPontos5,Ponto(500+passoX,500+passoY),Ponto(700+passoX,700+passoY),Ponto(460 + zoom,460  + zoom),Ponto(600+zoom,600+zoom)),pixArray,0xFFFFFF)
	#Primitivas.Poligono(Mapeamento(meusPontos5,Ponto(585+passoX,585+passoY),Ponto(700+passoX,700+passoY),Ponto(460 + zoom,460  + zoom),Ponto(600+zoom,600+zoom)),pixArray,0xFFFFFF)

	#Translacao e Rotacao
	quadradoCoordenadas=[Ponto(470,470),Ponto(450,470),Ponto(450,570),Ponto(470,570)]
