...
# Programa ******************************
	...
	Primitivas.Poligono(bj1Coordenadas,pixArray,0x0000FF)
	...
	Primitivas.Poligono(Mapeamento(quadradoCoordenadas,Ponto(0,0),Ponto(300,300),Ponto(0,0),Ponto(500,500)),pixArray,0xFFFFFF)
	#Primitivas.ScanLine(Mapeamento(trianguloCoordenadas,Ponto(0,0),Ponto(300,300),Ponto(0,0),Ponto(500,500)),pixArray,0xFFFFFF)
